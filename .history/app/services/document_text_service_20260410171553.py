...
class DocumentTextService:
    ...
    def identify_if_needs_ocr(self, data: bytes, source_path: str) -> tuple[bool, str, str]:
        ...
        if file_type == "pdf":
            ...
            reason = "PDF has little/no extractable text" if needs_ocr else "PDF text extraction succeeded"
    ...
    def extract_pure_text(self, data: bytes, source_path: str) -> tuple[str, bool, str, str]:
